...
- [disCategory - Categories](#Discuss.DatabaseModel-disCategoryCategories)
...
| collapsible | bool (1|0) | If the category should be allowed to be collapsible or not. |
...
| ignorable | boolean (1|0) | Wether this board can be ignored by users or not. |
...
| locked | boolean (1|0) | Wether this board is locked for posts or not. |
| integrated\_id | integer (10) | ?? |
| rtl | boolean (1|0) | Wether this board should use right to left formatting or not. |
