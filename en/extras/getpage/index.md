...
- [What is getPage?](#getPage-WhatisgetPage%3F)
...
| Name | Description | Default Value | Added In Version |
|------|-------------|---------------|------------------|
| pageNavOuterTpl | A content tpl for controlling the layout of the various page navigation controls. | ``` php 
[[+first]][[+prev]][[+pages]][[+next]][[+last]]

``` | 1.2.0-pl |
| pageNavTpl | A content tpl representing a single page navigation control. |  | ``` php 
<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>

``` |  |
| pageActiveTpl | A content tpl representing the current page navigation control. |  | ``` php 
<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>

``` |  |
| pageFirstTpl | A content tpl representing the first page navigation control. |  | ``` php 
<li class="control"><a[[+classes]][[+title]] href="[[+href]]">First</a></li>

``` |  |
| pageLastTpl | A content tpl representing the last page navigation control. |  | ``` php 
<li class="control"><a[[+classes]][[+title]] href="[[+href]]">Last</a></li>

``` |  |
| pagePrevTpl | A content tpl representing the previous page navigation control. |  | ``` php 
<li class="control"><a[[+classes]][[+title]] href="[[+href]]"><<</a></li>

``` |  |
| pageNextTpl | A content tpl representing the next page navigation control. |  | ``` php 
<li class="control"><a[[+classes]][[+title]] href="[[+href]]">>></a></li>
