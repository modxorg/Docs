...
A Chunk named "**Paging1**" is provided with AdvSearch. This Chunk name is set as &paging1Tpl property on the [AdvSearch](extras/advsearch/advsearch "AdvSearch.AdvSearch") snippet.
