...
| where         | A JSON-style expression of criteria to build any additional where clauses from. See [getResources &where](extras/getresources/where) for JSON examples. Operators match [xPDOQuery.where](extending-modx/xpdo/class-reference/xpdoquery/xpdoquery.where).                                                                                                                                                                                                                                                                                                                                  |                     |
...
More `&where` patterns (OR, `IN`, `LIKE`, grouped conditions): [getResources &where](extras/getresources/where).
