...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| headTpl           | This is the JS/CSS for the calendar goes in the `<head>` and can use the results from looping categoryHeadTpl like `[[+categoryHeadTpl]]` | ChurchEvents\_HeadTpl         |
