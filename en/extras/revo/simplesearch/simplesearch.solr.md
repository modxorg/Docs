---
title: "SimpleSearch.Solr"
_old_id: "1004"
_old_uri: "revo/simplesearch/simplesearch.solr"
---

<div>- [Requirements for Solr Search](#SimpleSearch.Solr-RequirementsforSolrSearch)
...
</div>Requirements for Solr Search
----------------------------
...
<div class="note">Those who installed SimpleSearch prior to 1.4.0-pl will need to update their schema.xml file to the latest version (referenced above in the docs/ directory) and reindex all their Resources to take advantage of TV-based searching.</div>Configuring SimpleSearch to use Solr
------------------------------------
...
<div class="info">If you are running multiple cores in Solr, often your "sisea.solr.path" setting will be something like "solr/corename".</div>### Index Your Existing Resources
