...
```<div class="note">Windows users can just do git archive HEAD and extract the tar file to wherever they want.</div>Then you can git init or whatever in that directory, and your files will be located there!
...
Once you've done all of that, you can create some [System Settings](/revolution/2.x/administering-your-site/settings/system-settings "System Settings") back in your MODx Revo site:
