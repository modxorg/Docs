...
### Login Page (1)
 ...
 ```
<pre class="brush: php">[[!Login? &loginTpl=`lgnLoginTpl` &logoutTpl=`lgnLogoutTpl` &errTpl=`lgnErrTpl` &loginResourceId=`4` &logoutResourceId=`5`]]
...
- _Probably hidden from most menus_
 ...
 ```
<pre class="brush: php">[[!ForgotPassword? &resetResourceId=`3` &tpl=`lgnForgotPassTpl`]]
