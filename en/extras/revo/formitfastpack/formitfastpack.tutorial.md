...
### 2. OPTIONAL: Use the fiGenerateReport hook to simplify your email templates. 
 ...
 ```
<pre class="brush: plain">[[!FormIt? &hooks=`math,spam,fiGenerateReport,email,redirect` ...]]<br>
...
<div class="warning"> Important: the tpl and outer\_tpl chunks use special comments to separate the HTML for different field types. Make sure each type is surrounded above and below by an HTML comment of the type name as shown below, or you might get more output than you expected! </div>```
