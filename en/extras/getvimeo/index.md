...
It can be downloaded from within the MODX Revolution manager via [Package Management](/en/building-sites/extras), or from the MODX Extras Repository, here: <https://modx.com/extras/package/getvimeo>
