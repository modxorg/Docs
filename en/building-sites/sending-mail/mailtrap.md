...
[Mailtrap](https://mailtrap.io) is a modern email platform for developer and product teams. It provides SMTP service (free plan available) that you can use to send transactional and bulk emails with high deliverability and fast delivery. 
