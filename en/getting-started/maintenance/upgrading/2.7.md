...
MODX Revolution 2.7.0 (November 2018) adds Trash Manager, native password hashing, static-element automation, and several Media Browser hardenings. Use this page when you move onto the 2.7 line. Full ticket list: [`core/docs/changelog.txt`](https://github.com/modxcms/revolution/blob/2.x/core/docs/changelog.txt).
...
## Features worth configuring after upgrade
