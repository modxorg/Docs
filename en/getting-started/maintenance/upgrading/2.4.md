...
MODX Revolution 2.4.0 (August 2015) adds package dependencies, namespace permissions, database indexes, and manager improvements. Use this page when you move onto the 2.4 line. For the full ticket list, see [`core/docs/changelog.txt`](https://github.com/modxcms/revolution/blob/2.x/core/docs/changelog.txt).
