...
MODX Revolution 2.8.0 (October 2020) focuses on manager security, file handling, and library updates. Use this page when you enter the 2.8 line. Continue with [the 2.8.2 / 2.8.3 notes](getting-started/maintenance/upgrading/2.8.2) before installing a later 2.8 release.
