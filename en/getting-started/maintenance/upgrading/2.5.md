...
MODX Revolution 2.5.0 (April 2016) focused on PHP 7 readiness, manager usability, and anonymous-request performance. Use this page when you move a site onto the 2.5 line. For the full list of tickets, see [`core/docs/changelog.txt`](https://github.com/modxcms/revolution/blob/2.x/core/docs/changelog.txt) in the Revolution repo.
...
## Notable additions (no forced config change)
