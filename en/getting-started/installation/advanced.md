...
3. [Friendly URLs on IIS](getting-started/friendly-urls/iis)
4. [Installation on a server running ModSecurity](getting-started/installation/troubleshooting/modsecurity)
5. [Nginx Server Config](getting-started/friendly-urls/nginx)
6. [Advanced Installation](getting-started/installation/advanced)
7. [Git Installation](getting-started/installation/git)
8. [Command Line Installation](getting-started/installation/cli)
9. [The Setup Config Xml File](getting-started/installation/cli/config.xml)
10. [Troubleshooting Installation](getting-started/installation/troubleshooting)
11. [Successful Installation, Now What Do I Do?](getting-started/getting-started)
