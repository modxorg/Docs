...
- `modParser095`, `modTranslate095`, and `modTranslator` have been removed. Those were utilities for migrating templates from older 1.x tag syntax. [#14133](https://github.com/modxcms/revolution/pull/14133)
