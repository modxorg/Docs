...
В MODX 3 не подключайте пути 2.x из `core/model/modx/processors/resource/`. Расширяйте `\MODX\Revolution\Processors\Resource\Create` и `Update`. Подробности в [шаге 4](extending-modx/custom-resources/step-4-processors) и на странице [пользовательских классов ресурсов](building-sites/resources/custom-resources).
