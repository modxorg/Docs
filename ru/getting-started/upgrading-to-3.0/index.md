...
Установщик принимает обновление только с **MODX 2.6.0 и новее**. На 2.5 и старше сначала дойдите до 2.6. Если текущая версия ниже 2.6.0, setup останавливается с ошибкой.
