...
Дружественные URL-адреса (FURLs) - это сокращение от SEO-дружественных URL-адресов. SEO, как вы, наверное, знаете, это аббревиатура от Search Engine Optimization. Так как «URL-адреса, оптимизированные для поисковых систем» звучит довольно скучно, их обычно называют FURL в MODX.
