...
| tvLabel                                  | Отображает метку с телевизора, полезную при использовании выбора или флажки и т.д., Где вы используете `Label==1||Otherlabel==2||More options==3` если значение 2 вернет Otherlabel.                                                                                                 | `[[+mySelectboxTv:tvLabel]]`                       |
