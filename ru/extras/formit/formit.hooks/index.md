...
Теги MODX в этой строке будут обработаны, после чего будет осуществлён поиск хука в `assets/hooks/my.hook.php`. Если файл найден, он будет работать с хуком из него.
