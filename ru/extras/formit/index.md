...
Просто поместите вызов [Сниппета](building-sites/elements/snippets "Сниппет") FormIt в Ресурс, содержащий форму, которую вы хотите использовать. Поместите вызов сниппета рядом с формой, которую хотите обработать. Не кладите форму в чанк и не ссылайтесь на этот чанк из вызова FormIt. Укажите «hooks» (или сценарии обработки после проверки) в вызове Сниппета. Затем добавьте проверку с помощью параметров `&validate` и `&customValidators`.
