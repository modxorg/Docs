---
title: "LexRating"
description: "jQuery рейтинг звёздами для MODX"
translation: "extras/lexrating/index"
---

LexRating ([goldsky](http://twitter.com/_goldsky)): jQuery star rating на базе [rateit.codeplex.com](http://rateit.codeplex.com) (by [gidon](http://twitter.com/gjunge)).

В MODX рейтинг сохраняется через AJAX.

Issues: [github's page](https://github.com/goldsky/LexRating/issues).
...
1. **LexRating**,
2. **LexRatingList** для списка результатов рейтинга.
...
Сниппет даёт посетителю поставить оценку объекту по имени.
Проверяется IP и ID авторизованного пользователя.
