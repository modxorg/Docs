---
title: "GridClassKey"
description: "Custom class key для grid дочерних ресурсов в менеджере MODX"
translation: "extras/gridclasskey/index"
---

GridClassKey: custom class key для менеджера MODX Revolution: дочерние ресурсы скрыты в grid контейнера.

Ресурс можно переключить на этот class key и вернуть на modResource через Resource Type на вкладке Settings.

Скрывает дочерние ресурсы в дереве и показывает их в grid. Форма как у modResource.

Баги и feature requests: <https://github.com/goldsky/GridClassKey/issues>

![](children.jpg)

## Настройки

Settings настраивают вид grid и поведение по клику.
...
У GridClassKey свой набор permissions.
