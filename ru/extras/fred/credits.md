---
title: "Благодарности"
description: "Open Source компоненты, используемые в Fred"
translation: "extras/fred/credits"
---

Fred использует компоненты с открытым исходным кодом. Исходники и информация о лицензиях по ссылкам ниже. Мы благодарны этим разработчикам за вклад в open source.
