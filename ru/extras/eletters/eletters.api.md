---
title: "API"
description: "API Eletters для триггеров и отправки писем из сниппетов"
translation: "extras/eletters/eletters.api"
---

## API Eletters

В версии 1.1 добавлен API для создания триггеров отправки писем по действию пользователя или из вашего сниппета/дополнения.

### Пример кода сниппета

#### Пример сниппета: core/components/eltters/elements/snippets/elettertriggerexample.snippet.php
