...
description: "Чанк tplLoginToComment для блока входа при requireAuth в QuipReply"
translation: "extras/quip/quip.quipreply/tpllogintocomment"
---

## Чанк tplLoginToComment QuipReply

Этот чанк выводится через свойство &tplLoginToComment сниппета [Quip.QuipReply](extras/quip/quip.quipreply "Quip.QuipReply").

Показывается при requireAuth=`1`, если пользователь не авторизован.
