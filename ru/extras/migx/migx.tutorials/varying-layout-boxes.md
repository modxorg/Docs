---
title: "MIGX: блоки с разной вёрсткой"
translation: "extras/migx/migx.tutorials/varying-layout-boxes"
description: "Настройка MIGX для добавления и редактирования блоков с одной, двумя или тремя колонками"
---
...
Пример родился в [этом обсуждении](http://forums.modx.com/thread/31581/tv-s-for-varying-page-layouts).
...
- [MIGX](extras/migx): создание и заполнение блоков в бэкенде MODX и вывод на фронтенде. ADDON/TinyMCE
