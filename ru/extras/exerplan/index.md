---
title: "ExerPlan"
description: "Планировщик тренировок для сайтов здравоохранения и спорта"
translation: "extras/exerplan/index"
---

ExerPlan: планировщик упражнений для сайтов здравоохранения и спортивных тренировок.
У каждой тренировки могут быть галереи (such as pictures, downloadable files, or video sources) as additional information to the members, eg: about the instructional material.

ExerPlan написал goldsky, релиз 25 мая 2013.

## Загрузка

Установите через менеджер MODX Revolution в разделе [Package Management](developing-in-modx/advanced-development/package-management "Package Management"), or from the MODX Extras Repository, available here: <https://modx.com/extras/package/exerplan>

## Разработка и сообщения об ошибках

ExerPlan на GitHub: <https://github.com/goldsky/ExerPlan>

## Custom Manager Page (CMP)

Админам и менеджерам простой UI для управления тренировками.

Объяснение с конца, от настроек.
